--[[
    ...
    Provides player movement information to other parts of the game
]]
...
function player_move:init(entity, player_input, variant)
...
function player_move:is_local_aim()
...
function player_move:get_current_world_aim()
